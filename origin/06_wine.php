...
<div class="addfood"><a class="linktoadd" href="add_wine.php">+ Добавить вино</a></div>
...
$source = mysql_query("SELECT * FROM vine_cats WHERE id='$onecat'");
...
if(msg === 'stop'){
	...
	<form id="catform-<?print $cat_id?>" method="post" action="admin_files/catstatus_wine.php" >
...
<div class="addfood"><a class="linktoadd" href="add_wine_cat.php">+ Добавить категорию</a></div>
...
<?
$source = mysql_query("SELECT * FROM vine_items WHERE vinecat_id='$cat_id'");
while($rowx = mysql_fetch_array($source)){
$d_id = $rowx['id'];
$d_cat = $rowx['vinecat_id'];
$d_name_ru = $rowx['vine_name_ru'];
$d_w = $rowx['weight'];
$d_ci = $rowx['w_ci_RU']; 
$d_price = $rowx['price'];
...
<form id="food_form-<?print $d_id;?>" method="post" action="admin_files/savewineprice.php">
	...
	<div class="food_name"><a class="toedit" href="editwine.php?id=<?print $d_id;?>"><?print $d_name_ru;?></a></div>
