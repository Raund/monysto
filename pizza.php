...
<div id="pizzarates" style="visibility: hidden;">
	...
	<!--<section class="food_menu">
		...
		<div class="food_menu_hello">
			<div class="big_header_b" style="padding-top: 120px; margin-bottom: 50px;">menu</div>
    ...
    <div class="carousel">
        <ul>
            <li id="mcat-1" class="cat_sel">
             <div class="menuicon cold_appertizers"></div>
             <div class="menuname">Cold appetizers</div>
            </li>
            
            <li id="mcat-2">
             <div class="menuicon soups"></div>
             <div class="menuname">Soups</div>
            </li>
            
            <li id="mcat-3">
             <div class="menuicon"></div>
             <div class="menuname">With beer</div>
            </li>
            ...
            <li id="mcat-5">
             <div class="menuicon"></div>
             <div class="menuname">Hot wine</div>
            </li>
...
$("#mcat-2").click(function() {
		...
		<div class="food_menu_inner">
			...
			<div class="food_menu_right">
				...
				<div class="food_cat">Vines card</div>
				
				
                
                <div class="inmenu">
	                
	                <div class="subcat">Italian Vines</div>
				...
				<div class="one_food">
					<div class="food_main_info">
					 ...
					 <div class="food_price">123,00 <span>UAH</span></div>
					 <div class="clear"></div>
					</div> 
					
					<div class="ingr">(ніжна печінка зі стиглими свіжими томатами та духмяними крутонами у часниково-гірчичному соусі)</div>
				</div>
				
				   <div class="subcat">French Vines</div>
				
				<div class="one_food">
					<div class="food_main_info">
					 <div class="food_name">Бограч</div>
					 <div class="food_w">150/250/400 г</div>
					 <div class="food_price">12,00 <span>UAH</span></div>
					 <div class="clear"></div>
					</div> 
				...
				<div class="one_food">
					<div class="food_main_info">
					 ...
					 <div class="food_price">60,00 <span>UAH</span></div>
					 <div class="clear"></div>
					</div> 
			...
			<div id="foodlist-2" style="display:none;">
			<div class="food_menu_right">
				
				<div class="food_cat">Second</div>
