...
$user_agent = 'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.1; Trident/4.0)';
  ...
  //echo '<div class="rates_x rb_x" onclick="window.open(\''.$link.'\',\'mywindow\');"><div class="rate_data_x" >'.$rr.'</div></div>';
  echo '<div class="rates_x rb_x"><div class="rate_data_x" >'.$rr.'</div></div>';
  ?>